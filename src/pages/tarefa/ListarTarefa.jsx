      ...
      backgroundColor: '#474342'
        ...
        <CardActions >
            <Button style={{margin: '10px',
                            width: '50%',
                            color: 'white',
                            backgroundColor: '#540034'
                            }}size="small" variant="contained" onClick={handleOpen}>Criar Tarefa</Button>
            <Button style={{margin: '10px',
                            width: '20%',
                            color: 'white',
                            backgroundColor: '#800034'
                            }}size="small" variant="outlined">Cancelar</Button>
      </CardActions> 
    </Card>
    <div>
      <Modal
